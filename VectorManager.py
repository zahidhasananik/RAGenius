...
class VectorManager:
    def __init__(self, database_path="./chroma_db"):
        ...
        # 3. Created or get a collection (Think of this as a table in a database)
...
if __name__ == "__main__":
    vm = VectorManager()
    # Example chunks (In reality, these come from My ingestion.py)
    sample_chunks = [
        "Excel Technologies provides 24/7 data management services.",
        "The company is based in the US and Bangladesh.",
        "AI engineers at Excel Technologies focus on financial sector solutions."
    ]
